...
#include "SkyliteApp_haiku.h"
#elif defined(Q_WS_MAC)
#include "SkyliteApp_mac.h"
#else
#include "SkyliteApp.h"
#endif
...
int main(int argc, char *argv[])
{
    ...
    SkyliteApp app(argc, argv, _q(dcpp::Util::getLoginName()+"EDCPP"));
    int ret = 0;
    ...
    app.setOrganizationName("SkyliteDC++ Team");
    app.setApplicationName("SkyliteDC++ Qt");
...
void catchSIG(int sigNum) {
    ...
    SkyliteApp *eapp = dynamic_cast<SkyliteApp*>(qApp);
...
void migrateConfig(){
    ...
    string old_config = home + "/.skylitedc++++/";
    ...
    string new_config = xdg_config_home + "/skylitedc++++/";
    ...
    try{
        ...
        QRegExp replace_str("/(\\S+)/\\.skylitedc++\\+\\+/");
        QString line = "";
