...
void MainWindow::showEvent(QShowEvent *e){
    ...
    if (_q(SETTING(NICK)).isEmpty()){
        ...
        if (ok && !new_nick.isEmpty()){
            ...
            ok = (QMessageBox::question(this, "SkyliteDC++", tr("Would you like to change other settings?"), QMessageBox::Yes, QMessageBox::No) == QMessageBox::No);
        }
...
void MainWindow::retranslateUi(){
    ...
    //Retranslate menu actions
    {
        ...
        d->aboutClient->setText(tr("About SkyliteDC++"));
...
void MainWindow::slotAboutOpenUrl(){
    ...
    if (act == d->aboutHomepage){
        QDesktopServices::openUrl(QUrl("http://code.google.com/p/skylitedc/"));
    }
    else if (act == d->aboutSource){
        QDesktopServices::openUrl(QUrl("http://github.com/skylitedcpp/skylitedcpp/"));
    }
    else if (act == d->aboutIssues){
        QDesktopServices::openUrl(QUrl("http://code.google.com/p/skylitedc/issues/list"));
    }
    else if (act == d->aboutWiki){
        QDesktopServices::openUrl(QUrl("http://code.google.com/p/skylitedc/w/list"));
    }
    else if (act == d->aboutChangelog){
        // Now available: ChangeLog.txt, ChangeLog_ru.txt, ChangeLog_uk.txt
        QDesktopServices::openUrl(QUrl(tr("http://github.com/skylitedcpp/skylitedcpp/raw/master/ChangeLog.txt")));
    }
}
...
void MainWindow::slotAboutClient(){
    ...
    QString about_text = tr("SkyliteDC++ is a graphical client for Direct Connect and ADC protocols.<br/><br/>"
                            ""
                            "DC++ core version: %1 (modified)<br/><br/>"
                            ""
                            "Home page: <a href=\"http://code.google.com/p/skylitedc/\">"
                            "http://code.google.com/p/skylitedc/</a><br/><br/>"
                            ""
                            "Total up: <b>%2</b><br/>"
                            "Total down: <b>%3</b><br/>"
                            "Ratio: <b>%4</b>"
    ...
    a.textBrowser_AUTHORS->setText(
        tr("Please use <a href=\"http://code.google.com/p/skylitedc/issues/list\">"
        "http://code.google.com/p/skylitedc/issues/list</a> to report bugs.<br/>")+
        QString("<br/>")+
    ...
    a.textBrowser_TRANSLATION->setText(
        ...
        "<a href=\"https://www.transifex.com/projects/p/skylitedcpp/\">"
        "https://www.transifex.com/projects/p/skylitedcpp/</a><br/>")+
        QString("<br/>")+
