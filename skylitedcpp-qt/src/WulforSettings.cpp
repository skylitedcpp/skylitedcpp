...
WulforSettings::WulforSettings():
        settings(_q(Util::getPath(Util::PATH_USER_CONFIG)) + "SkyliteDC++_Qt.conf", QSettings::IniFormat),
        tor(0)
{
    configFileOld = _q(Util::getPath(Util::PATH_USER_CONFIG)) + "SkyliteDC++.xml";
