...
void Hub::updateUser_gui(ParamMap params)
{
    ...
    const string icon = "skylitedcpp-" + params["Icon"];
...
void Hub::onSendMessage_gui(GtkEntry *entry, gpointer data)
{
    ...
    if (text[0] == '/')
    {
        ...
        {
            hub->addStatusMessage_gui(string(EISKALTDCPP_WND_TITLE)+" "+string(EISKALTDCPP_VERSION)+" ("+string(EISKALTDCPP_VERSION_SFX)+"), "+_("project home: ")+"http://code.google.com/p/skylitedc/", Msg::SYSTEM, Sound::NONE);
        }
