    ...
    DialogEntry(Entry::SETTINGS_DIALOG, "settingsdialog.ui", parent)
{
    ...
    defaultStringTheme.insert(StringMap::value_type("icon-dc++", "skylitedcpp-dc++"));
    defaultStringTheme.insert(StringMap::value_type("icon-dc++-fw", "skylitedcpp-dc++-fw"));
    defaultStringTheme.insert(StringMap::value_type("icon-dc++-fw-op", "skylitedcpp-dc++-fw-op"));
    defaultStringTheme.insert(StringMap::value_type("icon-dc++-op", "skylitedcpp-dc++-op"));
    defaultStringTheme.insert(StringMap::value_type("icon-normal", "skylitedcpp-normal"));
    defaultStringTheme.insert(StringMap::value_type("icon-normal-fw", "skylitedcpp-normal-fw"));
    defaultStringTheme.insert(StringMap::value_type("icon-normal-fw-op", "skylitedcpp-normal-fw-op"));
    defaultStringTheme.insert(StringMap::value_type("icon-normal-op", "skylitedcpp-normal-op"));
    defaultStringTheme.insert(StringMap::value_type("icon-smile", "face-smile"));
    defaultStringTheme.insert(StringMap::value_type("icon-download", "skylitedcpp-go-down"));
    defaultStringTheme.insert(StringMap::value_type("icon-favorite-hubs", "skylitedcpp-favserver"));
    defaultStringTheme.insert(StringMap::value_type("icon-favorite-users", "skylitedcpp-favusers"));
    defaultStringTheme.insert(StringMap::value_type("icon-finished-downloads", "skylitedcpp-go-down-search"));
    defaultStringTheme.insert(StringMap::value_type("icon-finished-uploads", "skylitedcpp-go-up-search"));
    defaultStringTheme.insert(StringMap::value_type("icon-hash", "skylitedcpp-hashing"));
    defaultStringTheme.insert(StringMap::value_type("icon-refresh", "skylitedcpp-refrlist"));
    defaultStringTheme.insert(StringMap::value_type("icon-preferences", "skylitedcpp-configure"));
    defaultStringTheme.insert(StringMap::value_type("icon-public-hubs", "skylitedcpp-server"));
    defaultStringTheme.insert(StringMap::value_type("icon-queue", "skylitedcpp-download"));
    defaultStringTheme.insert(StringMap::value_type("icon-search", "skylitedcpp-edit-find"));
    defaultStringTheme.insert(StringMap::value_type("icon-search-spy", "skylitedcpp-spy"));
    defaultStringTheme.insert(StringMap::value_type("icon-search-adl", "skylitedcpp-adls"));
    defaultStringTheme.insert(StringMap::value_type("icon-upload", "skylitedcpp-go-up"));
    defaultStringTheme.insert(StringMap::value_type("icon-quit", "skylitedcpp-application-exit"));
    defaultStringTheme.insert(StringMap::value_type("icon-connect", "skylitedcpp-network-connect"));
    defaultStringTheme.insert(StringMap::value_type("icon-reconnect", "skylitedcpp-reconnect"));
    defaultStringTheme.insert(StringMap::value_type("icon-file", GTK_STOCK_FILE));
    defaultStringTheme.insert(StringMap::value_type("icon-directory", "skylitedcpp-folder-blue"));
    defaultStringTheme.insert(StringMap::value_type("icon-openlist", "skylitedcpp-openlist"));
    defaultStringTheme.insert(StringMap::value_type("icon-own-filelist", "skylitedcpp-own_filelist"));
    defaultStringTheme.insert(StringMap::value_type("icon-magnet", "skylitedcpp-gui"));
...
bool Settings::loadFileTheme(const string &file)
{
    ...
    {
        dcdebug(_("skylitedcpp-gtk: load theme %s...\n"), e.getError().c_str());
        return FALSE;
    }
