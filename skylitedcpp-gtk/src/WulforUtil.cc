...
#else
    string xdg_config_home = Text::toUtf8(home) + "/.skylitedc++++/";
#endif
...
void WulforUtil::registerIcons()
{
    ...
    icons["skylitedcpp"] = "skylitedcpp";
    icons["icon_msg"] = wsm->getString("icon_msg");
    icons["skylitedcpp-dc++"] = wsm->getString("icon-dc++");
    icons["skylitedcpp-dc++-fw"] = wsm->getString("icon-dc++-fw");
    icons["skylitedcpp-dc++-fw-op"] = wsm->getString("icon-dc++-fw-op");
    icons["skylitedcpp-dc++-op"] = wsm->getString("icon-dc++-op");
    icons["skylitedcpp-normal"] = wsm->getString("icon-normal");
    icons["skylitedcpp-normal-fw"] = wsm->getString("icon-normal-fw");
    icons["skylitedcpp-normal-fw-op"] = wsm->getString("icon-normal-fw-op");
    icons["skylitedcpp-normal-op"] = wsm->getString("icon-normal-op");
