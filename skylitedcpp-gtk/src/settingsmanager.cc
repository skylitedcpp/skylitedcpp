...
WulforSettingsManager::WulforSettingsManager():
    configFile(Util::getPath(Util::PATH_USER_CONFIG) + "SkyliteDC++_Gtk.xml")
{
...
//  defaultInt.insert(IntMap::value_type("sound-download-begins-use", 0));
    ...
    defaultInt.insert(IntMap::value_type("urlhandler", 0));
    defaultInt.insert(IntMap::value_type("clearsearch", 0));
    ...
    defaultInt.insert(IntMap::value_type("hub-nickview-left", 0));
...
//  defaultString.insert(StringMap::value_type("sound-download-begins", ""));
    ...
    defaultString.insert(StringMap::value_type("icon-dc++", "skylitedcpp-dc++"));
    defaultString.insert(StringMap::value_type("icon-dc++-fw", "skylitedcpp-dc++-fw"));
    defaultString.insert(StringMap::value_type("icon-dc++-fw-op", "skylitedcpp-dc++-fw-op"));
    defaultString.insert(StringMap::value_type("icon-dc++-op", "skylitedcpp-dc++-op"));
    defaultString.insert(StringMap::value_type("icon-normal", "skylitedcpp-normal"));
    defaultString.insert(StringMap::value_type("icon-normal-fw", "skylitedcpp-normal-fw"));
    defaultString.insert(StringMap::value_type("icon-normal-fw-op", "skylitedcpp-normal-fw-op"));
    defaultString.insert(StringMap::value_type("icon-normal-op", "skylitedcpp-normal-op"));
    defaultString.insert(StringMap::value_type("icon-smile", "face-smile"));
    defaultString.insert(StringMap::value_type("icon-download", "skylitedcpp-go-down"));
    defaultString.insert(StringMap::value_type("icon-favorite-hubs", "skylitedcpp-favserver"));
    defaultString.insert(StringMap::value_type("icon-favorite-users", "skylitedcpp-favusers"));
    defaultString.insert(StringMap::value_type("icon-finished-downloads", "skylitedcpp-go-down-search"));
    defaultString.insert(StringMap::value_type("icon-finished-uploads", "skylitedcpp-go-up-search"));
    defaultString.insert(StringMap::value_type("icon-hash", "skylitedcpp-hashing"));
    defaultString.insert(StringMap::value_type("icon-refresh", "skylitedcpp-refrlist"));
    defaultString.insert(StringMap::value_type("icon-preferences", "skylitedcpp-configure"));
    defaultString.insert(StringMap::value_type("icon-public-hubs", "skylitedcpp-server"));
    defaultString.insert(StringMap::value_type("icon-queue", "skylitedcpp-download"));
    defaultString.insert(StringMap::value_type("icon-search", "skylitedcpp-edit-find"));
    defaultString.insert(StringMap::value_type("icon-search-spy", "skylitedcpp-spy"));
    defaultString.insert(StringMap::value_type("icon-search-adl", "skylitedcpp-adls"));
    defaultString.insert(StringMap::value_type("icon-upload", "skylitedcpp-go-up"));
    defaultString.insert(StringMap::value_type("icon-quit", "skylitedcpp-application-exit"));
    defaultString.insert(StringMap::value_type("icon-connect", "skylitedcpp-network-connect"));
    defaultString.insert(StringMap::value_type("icon-reconnect", "skylitedcpp-reconnect"));
    defaultString.insert(StringMap::value_type("icon-file", GTK_STOCK_FILE));
    defaultString.insert(StringMap::value_type("icon-directory", "skylitedcpp-folder-blue"));
    defaultString.insert(StringMap::value_type("icon-openlist", "skylitedcpp-openlist"));
    defaultString.insert(StringMap::value_type("icon-own-filelist", "skylitedcpp-own_filelist"));
    defaultString.insert(StringMap::value_type("icon-magnet", "skylitedcpp-gui"));
    defaultString.insert(StringMap::value_type("icon-pm-online", "skylitedcpp-users"));
    defaultString.insert(StringMap::value_type("icon-pm-offline", "skylitedcpp-users-red"));
    defaultString.insert(StringMap::value_type("icon-hub-online", "skylitedcpp-server"));
    defaultString.insert(StringMap::value_type("icon-hub-offline", "skylitedcpp-server-red"));
    //alias
