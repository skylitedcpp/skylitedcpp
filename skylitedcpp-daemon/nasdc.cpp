...
void printHelp() {
    printf("Using:\n"
           "  skylitedcpp-daemon -d [options]\n"
           "  skylitedcpp-daemon <Key>\n"
...
#ifdef XMLRPC_DAEMON
           "  -u <file>,  --rpclog=<file>\t Write xmlrpc log to <file> (default: /tmp/skylitedcpp-daemon.xmlrpc.log)\n"
           "  -U <uripath>,  --uripath=<uripath>\t Set UriPath for xmlrpc abyss server to <uripath> (default: /skylitedcpp)\n"
#endif
#endif // _WIN32
           );
}
...
int main(int argc, char* argv[])
{
    ...
    sTitle = "skylitedcpp-daemon (SkyliteDC++ core 2.2)";
