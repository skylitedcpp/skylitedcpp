...
void printBacktrace(int){
    std::cerr << "\n\n*************************************************************\n";
    std::cerr << "SkyliteDC++ version: " << EISKALTDCPP_VERSION << " " << EISKALTDCPP_VERSION_SFX << "\n";
    std::cerr << "Oops! Please report a bug at http://code.google.com/p/skylitedc/issues/list\n\n";
    std::cerr << "Stacktrace below is usually useless. Useful bug report should include full backtrace:\n"
                 "https://code.google.com/p/skylitedc/wiki/issue_hints_en\n\n";
    std::cerr << "Stacktrace:\n";
    print_stacktrace();
}
#endif
