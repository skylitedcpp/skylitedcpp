...
#------------------------------------------------------------------------------#
#
# SkyliteDC++ - personal info script.
#
#------------------------------------------------------------------------------#
#
...
* /alias p::/sh  /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php
* /alias u::/sh  /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php uptime
* /alias b::/sh  /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php black
* /alias r::/sh  /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php ratio
* /alias t::/sh  /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php torrent
* /alias ps::/sh /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php process
* /alias pn::/sh /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php ping
* /alias ip::/sh /usr/share/skylitedcpp/examples/commands.ru_RU.UTF-8.php ip
*
...
/**
  ...
  {
    $filename = '/home/'.$this->username.'/.skylitedc++++/SkyliteDC++.xml';

    if( file_exists( $filename ) )
    {
      $file = file_get_contents( $filename );
      exec('ps -o pcpu,time,rss -C skylitedcpp | tail -1 | awk \'{print $1,$2,$3}\'', $info);
  ...
  {
    $filename = "/home/{$this->username}/.skylitedc++++/blacklist";
...
$skylite = new SkyliteDC++;

if( count($skylite->errors) > 0 ) {
  print "php v.5.2 <, foo 'exec' not exists or os is not linux!";
}
elseif( method_exists($skylite, $method) ) {
  $str = $skylite->$method();
  print (!count($skylite->errors)) ? "+me -> $str\n" : "error result\n";
} else {
  print "Error usage!\n";
}
?>
